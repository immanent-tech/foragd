...
func Landing() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "<main class=\"isolate bg-base-100\"><div aria-hidden=\"true\" class=\"absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80\"><div class=\"soft-gradient-top\"></div></div><div class=\"relative pt-14\"><div class=\"lg:pb-40\"><div class=\"mx-auto max-w-7xl px-6 lg:px-8\"><div class=\"mx-auto mt-16 max-w-2xl text-center sm:mt-24\"><h1 class=\"text-base/7 font-semibold text-secondary\">Foragd — RSS & Feed Reader for the Web</h1><p class=\"mt-2 text-5xl font-semibold tracking-tight text-balance text-primary sm:text-7xl\">Algorithms decide.<br>You scroll.</p><p class=\"mt-6 text-lg/8 text-neutral\">Foragd is a web-based feed reader that aggregates RSS and feeds alongside email newsletters into a single interface. Unlike social platforms, it shows only content you choose, with no algorithmic curation, no ads, and full-text search across all articles.</p><div class=\"mx-auto items-center flow-root my-20\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = partials.LogoSmall(element.WithClasses("size-64", "mx-auto")).Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 12, "</dl></div></div><div class=\"relative -z-10 px-6 py-10 lg:px-8\"><div class=\"mx-auto max-w-2xl text-center\"><p class=\"text-4xl font-semibold tracking-tight text-balance sm:text-5xl\">Escape the algorithm. Own your information.</p><div class=\"mt-10 flex items-center justify-center gap-x-6\"><a href=\"#pricing\" class=\"btn btn-primary\">Start a free trial</a></div></div></div><div aria-hidden=\"true\" class=\"absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]\"><div class=\"soft-gradient-bottom\"></div></div></main></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
...
func landingFAQEntry(id, question string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/landing.templ`, Line: 406, Col: 28}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/landing.templ`, Line: 409, Col: 54}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/landing.templ`, Line: 417, Col: 33}
		}
