...
func Card(options ...element.PropertiesOption) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		var templ_7745c5c3_Var2 = []any{"card bg-base-200 border border-neutral/20 transition-shadow transition-opacity duration-250 ease-in-out hover:shadow-lg [&.htmx-swapping]:opacity-0 content-auto [contain-intrinsic-size:350px]", props.Classes()}
...
func CardBody(options ...element.PropertiesOption) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		props := element.NewProperties(options...)
		var templ_7745c5c3_Var8 = []any{"px-4 py-5 sm:p-6", props.Classes()}
...
func CardFooter(options ...element.PropertiesOption) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		props := element.NewProperties(options...)
		var templ_7745c5c3_Var11 = []any{"card-footer mt-auto px-4 pb-4 pt-2 sm:px-6", props.Classes()}
