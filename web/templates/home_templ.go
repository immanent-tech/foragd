			...
			if len(page.LatestArticles) > 0 {
				...
				for article := range slices.Values(page.LatestArticles) {
					...
					if img := article.GetImage(); img != nil {
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/home.templ`, Line: 91, Col: 54}
						}
					...
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 25, "</p><p class=\"flex-1 text-xs text-base-content/80 truncate\">")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
