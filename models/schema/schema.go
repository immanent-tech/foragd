				...
				templates.WithTemplateMapping(
					templates.WithProperties(
						...
						templates.WithObjectMapping("metadata",
							templates.WithBinaryMapping("blocked"),
							templates.WithBinaryMapping("email_verified"),
							templates.WithBinaryMapping("promotional_email"),
							templates.WithBinaryMapping("policies_accepted"),
						),
