...
func (e ArticleArchiveExtensionType) Valid() bool {
	switch e {
	case ArticleArchiveExtensionTypeYoutube:
		return true
	default:
		return false
	}
...
func (e SubscriptionMetadataType) Valid() bool {
	switch e {
	case SubscriptionMetadataTypeEmail:
		return true
	case SubscriptionMetadataTypeFeed:
		return true
	case SubscriptionMetadataTypeGroup:
		return true
	case SubscriptionMetadataTypeSearch:
		return true
	default:
		return false
	}
...
func (e UserMessageStatus) Valid() bool {
	switch e {
	case UserMessageStatusError:
		return true
	case UserMessageStatusInfo:
		return true
