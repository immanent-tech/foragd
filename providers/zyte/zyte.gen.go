...
// ArticleList is a list of articles extracted from the response.
type ArticleList struct {
	// Articles is the list of articles.
	Articles []Article `json:"articles" validate:"omitempty,dive"`
}
...
type Request struct {
	...
	ArticleListOptions *ExtractOptions `json:"articleListOptions,omitzero"`
...
type Response struct {
	...
	// ArticleList is a list of articles extracted from the response.
	ArticleList *ArticleList `json:"articleList,omitempty"`
