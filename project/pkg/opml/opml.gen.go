...
type Head struct {
	...
	DateModified *string `json:"dateModified,omitempty" xml:"dateModified,omitempty"`
...
type OPML struct {
	XMLName xml.Name `json:"opml" xml:"opml"`
...
type Outline struct {
	...
	// Outline is zero or more outline sub-elements.
	Outline []Outline `json:"outline,omitempty" xml:"outline,omitempty"`

	// Text is a textual description of the element.
	Text string `json:"text" xml:"text,required,attr"`
...
type RSSOutline struct {
	...
	HTMLURL *string `json:"htmlUrl,omitempty" xml:"htmlUrl,omitempty,attr"`
	...
	// Outline is zero or more outline sub-elements.
	Outline []RSSOutline `json:"outline,omitempty" xml:"outline,omitempty"`
	...
	XMLURL string `json:"xmlUrl" xml:"xmlUrl,attr"`
}
